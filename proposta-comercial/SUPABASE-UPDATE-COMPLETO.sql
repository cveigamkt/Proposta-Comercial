-- ============================================
-- SCRIPT COMPLETO DE ATUALIZAÇÃO DO BANCO
-- Execute ESTE script no SQL Editor do Supabase
-- ============================================

-- 1. Adicionar colunas de endereço e representante
...
-- 2. Adicionar colunas para comissão híbrida (% ou R$ fixo)
ALTER TABLE public.propostas_criadas 
...
COMMENT ON COLUMN public.propostas.endereco_cliente IS 'Endereço completo do cliente';
COMMENT ON COLUMN public.propostas.representante_cliente IS 'Nome do representante legal do cliente';
...
-- 4. Recriar view resumo_propostas com TODAS as colunas
